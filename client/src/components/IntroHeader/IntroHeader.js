...
const IntroHeader = props => {
  return (
      <React.Fragment>
        <div className='w-full bg-darkest-gray rounded p-4 mb-4'>
          <div className='text-light-gray text-base'>
            ...
            <p className='italic text-xs'>- They vote or comment on your post</p>
            <p className='italic text-xs'>- They pay to view content you've hidden behind a paywall</p>
            <p className='mb-3 italic text-xs'>- They simply want to show appreciation for your efforts by tipping you directly.</p> 
            ...
            <p className='mb-6'>If you have further questions, we encourage you to visit our FAQ page or contact us
              over Social Media.</p>
            <p className='mb-6'>Hope you like our platform!</p>
