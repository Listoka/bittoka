    ...
    return (
        <div className='card listItem' id={props._id}>
            <div className="card-body">
                ...
                <Link to={{pathname:'/editpage', state:{body: props.body, _id: props._id, title: props.title, teaser: props.teaser, authorName: props.authorName, categoryName: props.categoryName}}}><i className="far fa-edit"> Edit Post</i></Link>s
                </span>
                <br/>
